/**
 * SellerOrdersPage - Seller orders management
 */
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        {pendingCount > 0 && (
          <div className="mt-3 inline-flex items-center gap-2 bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm font-semibold">
            ...
            <div key={order.id} className="bg-white rounded-lg shadow-md">
              ...
              {order.status !== 'delivered' && order.status !== 'cancelled' && (
                <div className="px-6 pb-6 border-t">
                  <p className="text-sm font-semibold text-gray-700 mb-2">Ações rápidas:</p>
                  <div className="flex flex-wrap gap-2">
